<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="Lab16_2.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div class="cal">
            <asp:Label ID="1" Text="CALCULADORA BASICA" runat="server" Style="margin-left: 50px"
            ...
            <asp:Button ID="eql" Text="=" runat="server" Height="37px" Style="margin-left:0px"
                Width="57px" OnClick="eq_Click" />
            <asp:Button ID="clr" Text="C" runat="server" Height="37px" Style="margin-left:0px"
